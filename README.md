...
+ The source code, environment configuration file (i.e., dependencies list), and documentation will be here soon! I am hoping to get that out early 2026 at the latest. After that, for transparency, the code written for the model development and training process will also be provided "as-is" as a separate repository and linked to from here with less guarantee for functionality/reusability.
